...
export default function FindDoctor() {
  ...
  const copy: Record<string, {
    ...
    nameLabel: string; specLabel: string; locLabel: string;
    namePH: string; specPH: string; locPH: string; btn: string;
  }> = {
    en: {
      kicker: "Find A Doctor",
      heading: "Discover Your Ideal Medical Specialist",
      sub: "Connect with our network of certified healthcare professionals across all medical disciplines",
      nameLabel: "Practitioner Name",
      specLabel: "Medical Specialty",
      locLabel: "Location",
      namePH: "Search by name…",
      specPH: "Select specialty",
      locPH: "All locations",
      btn: "Search",
    },
    de: {
      kicker: "Arzt/Ärztin finden",
      heading: "Finden Sie Ihre passende Fachperson",
      ...
      locLabel: "Ort",
      namePH: "Nach Name suchen…",
      specPH: "Fachgebiet wählen",
      locPH: "Alle Orte",
      btn: "Suchen",
    },
    fr: {
      kicker: "Trouver un médecin",
      heading: "Trouvez votre spécialiste idéal",
      sub: "Connectez-vous à notre réseau de professionnels de santé certifiés",
      nameLabel: "Nom du praticien",
      specLabel: "Spécialité médicale",
      locLabel: "Lieu",
      namePH: "Rechercher par nom…",
      specPH: "Choisir une spécialité",
      locPH: "Tous les lieux",
      btn: "Rechercher",
    },
  };
        ...
        <form className={styles.panel} onSubmit={goDirectory}>
          <div className="row g-3 align-items-center">
            <div className="col-lg-4">
              <label className="form-label small">{t.nameLabel}</label>
            ...
            <div className="col-lg-4">
              <label className="form-label small">{t.specLabel}</label>
              <div className="input-group">
            ...
            <div className="col-lg-3">
              <label className="form-label small">{t.locLabel}</label>
              <div className="input-group">
