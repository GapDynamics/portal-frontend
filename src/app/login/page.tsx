...
export default function LoginPage() {
  ...
  const copy: Record<string, {
    ...
    de: {
      ...
      subtitle: "Greif auf dein OmniCheck Network Konto zu.",
      pitchTitle: "Sicher und nahtlos",
      pitch1: "Deine Daten sind geschützt und privat.",
      pitch2: "Mach überall dort weiter, wo du aufgehört hast.",
      pitch3: "Arbeite mit deinem Behandlungsteam zusammen.",
